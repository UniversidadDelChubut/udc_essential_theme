...
<html>    
    <head>
        <meta charset="UTF-8">
        <title>Ayuda al Estudiante</title>
    ...
    <body>
        <div style="width: 100%; height: 50px; background-color: blue; color: white; font-size: 15pt" align="center">
            <br>Aca iria la barra de navegacion de la ayuda a los ALUMNOS
        </div>
        <hr>
        ...
        <div class="alert alert-success" align="center">
            <br>
                <h2>Este es un ejemplo de lo que sería la página de ayuda para los "usuarios" que ya 
                    están logueados como ALUMNOS en al menos 1 curso de Moodle de la UDC.<br>
                    Hay que tener en cuenta que sólo cuando se entre a un curso donde es alumno
                    saldrá el botón para la AYUDA AL ALUMNO.
                </h2>
             <br>
        </div>
        <hr>
