...
function theme_udcessential_set_fontwww($css) {
    global $CFG, $PAGE;
 ...
 */
function theme_udcessential_set_logo($css, $logo) {
    global $OUTPUT;
    $tag = '[[setting:logo]]';
    $replacement = $logo;
...
function theme_udcessential_process_css($css, $theme) {
    ...
    $css = theme_udcessential_set_headingfont($css, $headingfont);
    $css = theme_udcessential_set_bodyfont($css, $bodyfont);
    $css = theme_udcessential_set_bodysize($css, $bodysize);
    $css = theme_udcessential_set_bodyweight($css, $bodyweight);
    ...
    $css = theme_udcessential_set_themecolor($css, $themecolor);
    ...
    $css = theme_udcessential_set_themehovercolor($css, $themehovercolor);
    ...
    $css = theme_udcessential_set_footercolor($css, $footercolor);
    ...
    $css = theme_udcessential_set_footersepcolor($css, $footersepcolor);
    ...
    $css = theme_udcessential_set_footertextcolor($css, $footertextcolor);
    ...
    $css = theme_udcessential_set_footerurlcolor($css, $footerurlcolor);
    ...
    $css = theme_udcessential_set_footerhovercolor($css, $footerhovercolor);
...
// Set the footer heading color.
    ...
    $css = theme_udcessential_set_footerheadingcolor($css, $footerheadingcolor);
    ...
    $css = theme_udcessential_set_navbarsep($css, $navbarsep);
    ...
    $css = theme_udcessential_set_logo($css, $logo);
    
    // Set the background image for the page.
    $setting = 'pagebackground';
    $pagebackground = $theme->setting_file_url($setting, $setting);
    $css = theme_udcessential_set_pagebackground($css, $pagebackground, $setting);
    ...
    $css = theme_udcessential_set_slideimage($css, $slideimage, $setting);
    ...
    $css = theme_udcessential_set_marketingheight($css, $marketingheight);
    ...
    $css = theme_udcessential_set_marketingimage($css, $marketingimage, $setting);
    ...
    // Set the font path.
    $css = theme_udcessential_set_fontwww($css);
    return $css;
}

function theme_udcessential_set_headingfont($css, $headingfont) {
...
function theme_udcessential_set_bodyfont($css, $bodyfont) {
...
function theme_udcessential_set_bodysize($css, $bodysize) {
...
function theme_udcessential_set_bodyweight($css, $bodyweight) {
...
function theme_udcessential_set_themecolor($css, $themecolor) {
...
function theme_udcessential_set_themehovercolor($css, $themehovercolor) {
...
function theme_udcessential_set_footercolor($css, $footercolor) {
...
function theme_udcessential_set_footertextcolor($css, $footertextcolor) {
...
function theme_udcessential_set_footerurlcolor($css, $footerurlcolor) {
...
function theme_udcessential_set_footerhovercolor($css, $footerhovercolor) {
...
function theme_udcessential_set_footerheadingcolor($css, $footerheadingcolor) {
...
function theme_udcessential_set_footersepcolor($css, $footersepcolor) {
...
function theme_udcessential_set_navbarsep($css, $navbarsep) {
...
function theme_udcessential_set_pagebackground($css, $pagebackground, $setting) {
    global $OUTPUT;
...
function theme_udcessential_set_slideimage($css, $slideimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
...
function theme_udcessential_set_marketingheight($css, $marketingheight) {
...
function theme_udcessential_set_marketingimage($css, $marketingimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
...
function theme_udcessential_page_init(moodle_page $page) {
    $page->requires->jquery();
    $page->requires->jquery_plugin('cslider', 'theme_udcessential');
    $page->requires->jquery_plugin('custom', 'theme_udcessential'); 
    $page->requires->jquery_plugin('alert', 'theme_udcessential');
    $page->requires->jquery_plugin('carousel', 'theme_udcessential');
    $page->requires->jquery_plugin('collapse', 'theme_udcessential');
    $page->requires->jquery_plugin('modal', 'theme_udcessential');
    $page->requires->jquery_plugin('scrollspy', 'theme_udcessential');
    $page->requires->jquery_plugin('tab', 'theme_udcessential');
    $page->requires->jquery_plugin('tooltip', 'theme_udcessential');
    $page->requires->jquery_plugin('transition', 'theme_udcessential');
    $page->requires->jquery_plugin('modernizr', 'theme_udcessential');  
}